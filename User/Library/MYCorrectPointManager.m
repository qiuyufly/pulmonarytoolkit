classdef MYCorrectPointManager < PTKTool
    ...
    methods
        ...
        function Correct(obj,enable)
            if enable
                ...
                [slice_markers] = obj.GetCorrectPoints(obj.ViewerPanel.SliceNumber(obj.ViewerPanel.Orientation), obj.ViewerPanel.Orientation);
                obj.StartFissureBrush([slice_markers{1}.x , slice_markers{1}.y]);
                ...
                obj.ViewerPanel.OverlayImage = results;
    ...
    methods (Access = private)
        ...
        function [slice_markers] = GetCorrectPoints(obj)
            if obj.MarkerPointImage.MarkerImageExists
                obj.Orientation = obj.ViewerPanel.SliceNumber(obj.ViewerPanel.Orientation);
                obj.SliceNumber = obj.ViewerPanel.Orientation;

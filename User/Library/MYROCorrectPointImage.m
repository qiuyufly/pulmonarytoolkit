classdef MYROCorrectPointImage < handle
    ...
    methods
        function obj = MYROCorrectPointImage
        ...
        function RemoveAllCorrectPoints(obj)
            CorrectPointImage = obj.MarkerImage;
            CorrectRawImage = CorrectPointImage.RawImage;
            BlankRawImage = zeros(size(CorrectRawImage));
            CorrectPointImage.ChangeRawImage(BlankRawImage);
            obj.MarkerImage = CorrectPointImage;
        end

classdef MYRHCorrectPointManager < PTKTool
    ...
    methods
        function obj = MYRHCorrectPointManager(viewer_panel, callback)
            obj.ViewerPanel = viewer_panel;
            obj.Callback = callback;
            obj.UndoStack = PTKUndoStack([], 5);
            obj.MarkerPointImage = MYRHCorrectPointImage;
        end
        ...
        function Correct(obj,enable,slice_markers)
            if enable
                ...
                results = MYGetResultsForRightHorizontalLobe(lung_mask.Copy, fissure_plane.Copy, reporting);
                obj.RH_lobe = results;
                end
                
                obj.ViewerPanel.OverlayImage = obj.RH_lobe;
                ...
                obj.RH_lobe = obj.ViewerPanel.OverlayImage.Copy;
...
%                 lobe2_overlay_image = zeros(size(new_lobe_overlay_image));
                ...
                lobe_mask = obj.RH_lobe.RawImage;

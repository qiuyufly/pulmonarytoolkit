function separated_mask = MYRHCorrectDivideVolumeUsingScatteredPoints(volume_mask, scattered_points, volume_fraction_threshold, reporting)
...
if isempty(separated_mask.RawImage)

classdef MYROCorrectMarkerMode < PTKGuiPlugin
    ...
    properties
        ButtonText = 'Select RO Correct Point'
        SelectedText = 'Hide Markers'
        ToolTip = 'Show the landmark points for right oblique fissure correction'
        Category = 'Correct'
        Visibility = 'Dataset'
        Mode = 'Edit'
    ...
    methods (Static)
        function RunGuiPlugin(ptk_gui_app)
            if ptk_gui_app.ImagePanel.IsInMarkerMode
                ...
                ptk_gui_app.ImagePanel.SetControl('MYROMark');
            end

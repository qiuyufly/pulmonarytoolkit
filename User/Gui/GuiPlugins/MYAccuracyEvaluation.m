classdef MYAccuracyEvaluation < PTKGuiPlugin
    ...
    properties
        ButtonText = 'Accuracy Evaluation'
    ...
    methods (Static)
        function RunGuiPlugin(ptk_gui_app)
            ...
            for i = 1:3
                ...
                AA=[];BB=[];CC=[];DD=[];EE=[];
                eval(['length_number=length(', manual_file_name, ');'])
...
%                     end
                ...
                eval(['MYExportField(output_file_name,' manual_file_name, ',', distance_file_name,...
                    ',group_name,(i-1)*20000,Fissure_accuracy_path);'])

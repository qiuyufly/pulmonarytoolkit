classdef PTKLeftObliqueSearchingRegionSlider < PTKGuiPluginSlider
    ...
    properties
        ButtonText = 'LO Searching Region'
        SelectedText = 'Left Oblique Searching Region'
        ToolTip = 'change the searching region of left oblique fissure'
    ...
    methods (Static)
        ...
        function [instance_handle, value_property_name, limits_property_name] = GetHandleAndProperty(ptk_gui_app)
            ...
            value_property_name = 'LORegion';
            limits_property_name = 'LORegionLimits';
        end

classdef PTKRightObliqueSearchingRegionSlider < PTKGuiPluginSlider
    ...
    properties
        ButtonText = 'RO Searching Region'
        SelectedText = 'Right Oblique Searching Region'
        ToolTip = 'change the searching region of right oblique fissure'
    ...
    methods (Static)
        ...
        function [instance_handle, value_property_name, limits_property_name] = GetHandleAndProperty(ptk_gui_app)
            ...
            value_property_name = 'RORegion';
            limits_property_name = 'RORegionLimits';
        end

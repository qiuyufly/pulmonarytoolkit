classdef MYRHCorrectMarkerMode < PTKGuiPlugin
    ...
    properties
        ButtonText = 'Select RH Correct Point'
        SelectedText = 'Hide Markers'
        ToolTip = 'Show the landmark points for right horiziontal fissure correction'
        Category = 'Correct'
        Visibility = 'Dataset'
        Mode = 'Edit'
    ...
    methods (Static)
        function RunGuiPlugin(ptk_gui_app)
            if ptk_gui_app.ImagePanel.IsInMarkerMode
                ...
                ptk_gui_app.ImagePanel.SetControl('MYRHMark');
            end

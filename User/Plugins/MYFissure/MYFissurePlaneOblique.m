classdef MYFissurePlaneOblique < PTKPlugin
    ...
    properties
        ButtonText = 'My Fissure Plane<br>Oblique'
        ToolTip = ''
        Category = 'Fissures'
    ...
    methods (Static)
        function results = RunPlugin(application, reporting)
            ...
            max_fissure_points = application.GetResult('MYMaximumFissurePointsOblique');
            left_and_right_lungs = application.GetResult('PTKLeftAndRightLungs');
            
            results_left = MYFissurePlaneOblique.GetLeftLungResults(max_fissure_points, application.GetResult('PTKGetLeftLungROI'), left_and_right_lungs, reporting);
            results_right = MYFissurePlaneOblique.GetRightLungResults(max_fissure_points, application.GetResult('PTKGetRightLungROI'), left_and_right_lungs, reporting);

classdef MYLobesFromFissurePlaneOblique < PTKPlugin
    ...
    methods (Static)
        function results = RunPlugin(application, reporting)
            ...
            fissure_plane = application.GetResult('MYFissurePlaneOblique');
            ...
            results_left = MYLobesFromFissurePlaneOblique.GetLeftLungResults(left_lung_template, lung_mask.Copy, fissure_plane.Copy, reporting);
            results_right = MYLobesFromFissurePlaneOblique.GetRightLungResults(right_lung_template, lung_mask, fissure_plane, reporting);

classdef PTKFissurenessROIOblique < PTKPlugin
    ...
    methods (Static)
        function results = RunPlugin(application, reporting)
            ...
            PTKresults_left = PTKFissurenessROIOblique.GetLeftResultsForLung(fissure_approximation, application.GetResult('PTKGetLeftLungROI'), PTKfissureness, 6, []);
            PTKresults_right = PTKFissurenessROIOblique.GetRightResultsForLung(fissure_approximation, application.GetResult('PTKGetRightLungROI'), PTKfissureness, 2, 3);
            MYresults_left = PTKFissurenessROIOblique.GetLeftResultsForLung(fissure_approximation, application.GetResult('PTKGetLeftLungROI'), MYfissureness, 6, []);
            MYresults_right = PTKFissurenessROIOblique.GetRightResultsForLung(fissure_approximation, application.GetResult('PTKGetRightLungROI'), MYfissureness, 2, 3);
            results = [];

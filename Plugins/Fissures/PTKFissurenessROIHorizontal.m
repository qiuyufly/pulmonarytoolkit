classdef PTKFissurenessROIHorizontal < PTKPlugin
    ...
    methods (Static)
        function results = RunPlugin(application, reporting)
            ...
            PTKresults_right_mid = PTKFissurenessROIHorizontal.GetRightLungResults(oblique_fissures, fissure_approximation, PTKfissureness, application.GetResult('PTKGetRightLungROI'));
            MYresults_right_mid = PTKFissurenessROIHorizontal.GetRightLungResults(oblique_fissures, fissure_approximation, MYfissureness, application.GetResult('PTKGetRightLungROI'));
            results = [];

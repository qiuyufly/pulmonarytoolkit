classdef PTKLeftMaximumFissurePointsOblique < PTKPlugin
    ...
    properties
        ButtonText = 'Left Fissureness <br>Maxima Oblique'
        ToolTip = ''
        Category = 'Fissures'
    ...
    methods (Static)
        function results = RunPlugin(application, reporting)
            ...
            results = PTKLeftMaximumFissurePointsOblique.GetResultsForLung(fissure_approximation, fissureness_roi.LeftMainFissure, application.GetResult('PTKGetLeftLungROI'), left_and_right_lungs, 2, 6, 'left', reporting);
%             results_right = PTKLeftMaximumFissurePointsOblique.GetResultsForLung(fissure_approximation, fissureness_roi.RightMainFissure, application.GetResult('PTKGetRightLungROI'), left_and_right_lungs, 1, 2, 'right', reporting);

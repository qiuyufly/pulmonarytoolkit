classdef PTKViewerPanelCallback < PTKBaseClass
    ...
    methods
        ...
        function obj = PTKViewerPanelCallback(viewing_panel, viewing_panel_multi_view, tools, toolbar, reporting)
            ...
            obj.AddPostSetListener(obj.ViewerPanel, 'LORegion', @obj.SettingsChangedCallback);
            obj.AddPostSetListener(obj.ViewerPanel, 'RORegion', @obj.SettingsChangedCallback);
            obj.AddPostSetListener(obj.ViewerPanel, 'RHRegion', @obj.SettingsChangedCallback);
            obj.AddPostSetListener(obj.ViewerPanel, 'Connected', @obj.SettingsChangedCallback);
            obj.AddPostSetListener(obj.ViewerPanel, 'LOEigConnected', @obj.SettingsChangedCallback);
            obj.AddPostSetListener(obj.ViewerPanel, 'ROEigConnected', @obj.SettingsChangedCallback);
            obj.AddPostSetListener(obj.ViewerPanel, 'RHEigConnected', @obj.SettingsChangedCallback);

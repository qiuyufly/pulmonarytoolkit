classdef PTKViewerPanel < PTKPanel
    ...
    properties (SetObservable)
        ...
        LORegion = 20           % The serching Region for left oblique fissure
        RORegion = 20           % The serching Region for right oblique fissure
        RHRegion = 15           % The serching Region for right horizontal fissure
        Connected = 300         % The number of connected component voxels
        LOEigConnected = 30    % The number of eigenvector based minimum connected component size for left oblique fissure
        ROEigConnected = 30    % The number of eigenvector based minimum connected component size for right oblique fissure
        RHEigConnected = 30    % The number of eigenvector based minimum connected component size for right horizontal fissure
    ...
    properties (SetObservable, SetAccess = private)
        ...
        LORegionLimits         % The limits of the serching region for left oblique fissure
        RORegionLimits         % The limits of the serching region for right oblique fissure
        RHRegionLimits         % The limits of the serching region for right horizontal fissure
        ConnectedLimited       % The limits of the number of connected component voxels
        LOEigConnectedLimited  % The limits of the number of eigenvector based connected component voxels for left oblique fissure
        ROEigConnectedLimited  % The limits of the number of eigenvector based connected component voxels for right oblique fissure
        RHEigConnectedLimited  % The limits of the number of eigenvector based connected component voxels for right horizontal fissure
    end
    ...
    methods
        ...
        function GetMultiCorrectToolFromToollist(obj)
            obj.Tools.GetMultiCorrectTool;
        end

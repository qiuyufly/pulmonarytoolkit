...
%     % These command are only used for the subject which has error of the first
%     % axial slice---Added by Yuwen
%     raw_image = threshold_image.RawImage;
%     raw_image(:,:,1) = zeros(size(raw_image(:,:,1)));
